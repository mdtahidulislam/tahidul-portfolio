...
const Home = () => {
    return (
        <div>
            ...
            <div className="connect connect--left">
                <div className="connect__box">
                    <ul className="connect__social">
                        <li>
                            <a href="https://github.com/mdtahidulislam">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/tahidulislam/">
            ...
            <div className="connect connect--right">
                <div className="connect__box">
                    <a className="connect__email" href="mailto:tahidul.developer@gmail.com">tahidul.developer@gmail.com</a>
                </div>
            </div>
        </div>
    );
